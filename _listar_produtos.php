...
<div class="container" id="con">
  ...
  <thead>
    <tr style="color: #6959CD; font-size: 20px;">
      ...
      <td> <?php echo $fornecedor ?> </td>
        ...
        ?>
      	<a  style="color:white;"class="btn btn-warning" role="button" href="_editar_produto.php?id=<?php echo $id ?>"><i class="far fa-edit"></i> Editar </a> 
       </td>
 ...
 if($nivel==1){
      ?>
      <td>
      	<a  style="color:white;"class="btn btn-danger" role="button" href="_deletar_produto.php?id=<?php echo $id ?>"><i class="far fa-trash-alt"></i> Delete </a>
